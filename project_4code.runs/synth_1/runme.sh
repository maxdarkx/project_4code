...
HD_PWD='C:/Users/Juan Carlos/Documents/Vivado/project_4code/project_4code.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log machine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source machine.tcl
