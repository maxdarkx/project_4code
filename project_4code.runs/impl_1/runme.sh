...
HD_PWD='C:/Users/Juan Carlos/Documents/Vivado/project_4code/project_4code.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source machine.tcl -notrace
