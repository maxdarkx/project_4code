...
#	set_property IOSTANDARD LVCMOS33 [get_ports {ori[0]}]

#set_property PACKAGE_PIN W17 [get_ports {ori[1]}]			
#	set_property IOSTANDARD LVCMOS33 [get_ports {ori[1]}]

#set_property PACKAGE_PIN W15 [get_ports {ori[2]}]				
#   set_property IOSTANDARD LVCMOS33 [get_ports {ori[2]}]

#set_property PACKAGE_PIN V15 [get_ports {ori[3]}]				
#   set_property IOSTANDARD LVCMOS33 [get_ports {ori[3]}]
############################################################
